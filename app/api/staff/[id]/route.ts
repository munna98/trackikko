...
const editStaffSchema = z.object({
  ...
  defaultMachineId: z.string().optional().nullable(),
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const { name, roleId, username, mobile, address, bloodGroup, designation, baseSalary, defaultMachineId, defaultSiteId, defaultAccountId } = parsed.data
    ...
    await prisma.user.update({
      ...
      data: {
        ...
        ...(defaultMachineId !== undefined && { defaultMachineId: defaultMachineId || null }),
